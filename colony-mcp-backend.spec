...
a = Analysis(
    ...
    datas=[('src/colony_mcp', 'colony_mcp')],
...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, a.binaries, a.zipfiles, a.datas, name='colony-mcp-backend', debug=False, strip=False, upx=False, upx_exclude=[],
