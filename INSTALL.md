...
4. Start the server:
   ...
   uv run python -m colony_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn colony_mcp.server:app --port 10970
   ```
5. Open `http://localhost:10970` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/colony-mcp/issues) |
